...
- Fresh remote heads re-polled at audit time:
  - `origin/lane/reliable-executor` -> `50751002253e7ba1a0256261ea903dea78f4e5a5` (`Tighten packaged Playground readiness probes`)
...
| Production auth/session lifecycle | The release verifier still reaches packaged source and readiness probes on the checked path. | Production-backed issuance, read, expiry, rotation, revocation, replay rejection, and cleanup on the live `verify:release` boundary. | Blocked |
