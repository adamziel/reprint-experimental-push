...
- This checkout does not carry that release gate in-tree. The primary release blocker remains the missing production-boundary proof for auth/session lifecycle plus durable journal semantics inside this checkout.
