...
Fresh iteration recheck on 2026-05-25: `node --test` still passes at `89/89` in the current checkout, but that result remains regression evidence only because there is still no checked-in live-source release gate.
