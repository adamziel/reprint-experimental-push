...
- Audit time: 2026-05-27 02:39:05 CEST (+0200)
- Fresh remote heads re-polled at audit time:
  - `origin/lane/reliable-executor` -> `2aa02bf7954f93bc4219a16e31e2a6b7c2166b16` (`Bind packaged auth source to runtime URL`)
...
`2aa02bf7954f93bc4219a16e31e2a6b7c2166b16` is the current reliable head. It builds on `c245a6fd` by rebinding the packaged auth-session source command to the actual runtime Playground URL and by making the checked fixture fail if stale `http://127.0.0.1:8080` appears in emitted proof. Reliable’s note and the diff show a real packaging/verifier integrity fix, but it remains inside Playground package-mode release verification rather than the missing production-owned source boundary.
