...
- `origin/lane/reliable-executor` -> `c99b19d0`
- `origin/lane/no-data-loss-invariants` -> `0511cbeb`
...
- `origin/lane/same-plan-wordpress-graph-create` -> `a0b82397`
- `origin/lane/cycle-20260525-mainwindows-2357/no-data-loss-invariants-graph-proof` -> `98c0ce26`
- `origin/lane/cycle-20260525-mainwindows-2349/feedback-supervisor` -> `53fb3f2d`
...
- `verify:release` now fails closed earlier when live-source production credentials are absent, and it times out long fetches instead of waiting indefinitely. That is a safer lab boundary, not a production auth/session proof.
