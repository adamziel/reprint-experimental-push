...
Only executable evidence at the boundary being claimed counts as proof. Fixture passes, lab backends, and refusal-only tests are useful, but they do not clear a production release claim unless they exercise the same boundary that the claim names.
