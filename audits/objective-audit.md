...
| Reliability | Fixture refusal, journal guardrails, and lab smokes prove negative cases | One enforced release gate that composes auth/session, durable journal, leases/fencing, graph identity, and plugin-driver checks | Production reliability is still unproven at the live boundary |
