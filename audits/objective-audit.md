...
- `npm run test:playground:production-shaped-push` passed against
  ...
  only. The route shape matched the production path, but the executor remained
  lab-backed, so this is compatibility evidence rather than proof of live
