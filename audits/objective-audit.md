...
- A direct filesystem check found no `.github` tree in this checkout, so there is also no checked-in workflow entrypoint that could enforce a missing release gate from the repository side.
