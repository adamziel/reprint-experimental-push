...
- This checkout exposes helper and Playground scripts, but it does not carry a checked `verify:release` command surface in-tree. That is enforcement debt in this lane, but it is not the primary release blocker anymore.
