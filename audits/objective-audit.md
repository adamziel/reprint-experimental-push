...
| Release blocker | No checked-in command fails closed on the missing live-source proof set, and no checked-in default entrypoint closes the gap | Release remains blocked |
