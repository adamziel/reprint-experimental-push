...
- `origin/lane/reliable-executor` at [`b1a41539`](https://github.com/adamziel/reprint-experimental-push/commit/b1a41539) does expose `verify:release` and maps it to `test:playground:production-shaped-release-verify`, so command absence is no longer the right blocker to cite.
