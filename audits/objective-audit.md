...
- Fresh remote heads re-polled at audit time:
  - `origin/lane/reliable-executor` -> `3568710293ad698b0ba3573ed162c16740520bf4` (`Track auth session cleanup and revocation`)
