...
| Publish or refuse a speed claim | Benchmark refusal tests block unsupported throughput claims. | A measured runtime or memory result from the production-shaped push path, with stated thresholds. | Yes: speed is unproven. |
