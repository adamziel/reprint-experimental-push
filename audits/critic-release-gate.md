...
- any source-note comparison that only proves route shape, package mount shape, reviewer wording, or fixture replay stays compatibility evidence only, even if it names the upstream revision; and
