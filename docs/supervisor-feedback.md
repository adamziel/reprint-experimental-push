...
Last updated: 2026-05-25 10:45:06 CEST

This is the short feedback loop for the supervisor. Keep it focused on what
changed, what is helping, what is not helping, and the next nudge.

## 2026-05-25 10:45:06 CEST
...
- Next nudge: `integration` owns the next real-site release command; `reliable-executor` should keep the gate tied to a real endpoint; `invariants` and `recovery` should stay quiet until they can attach to that same run.
