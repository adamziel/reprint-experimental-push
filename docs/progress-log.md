...
- Last update: 2026-05-25 02:59:36 CEST.
- Status: Lab/model evidence still holds; production proof is still missing.
- Trend: the visible page, this log, and the newest supervisor note stay aligned; the public page now leans on links instead of repeating the same gate text.
