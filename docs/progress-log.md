...
- Last update: 2026-05-25 03:15:44 CEST.
- Status: Lab/model evidence still holds; production proof is still blocked by missing evidence.
- Trend: the visible page, this log, and the newest supervisor note stay aligned; the public page keeps the merge note to one line and pushes readers toward the linked proof trail.
