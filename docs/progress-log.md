...
- Last update: 2026-05-25 04:38:04 CEST.
- Status: lab evidence still holds; production proof stays blocked.
- Trend: the visible page and this log still line up, and the public page now points at the proof trail instead of repeating it.
