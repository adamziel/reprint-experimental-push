...
- Last update: 2026-05-25 04:46:46 CEST.
- Status: lab evidence still holds; production proof remains blocked.
- Trend: the visible page and this log still line up, and the public page now reads as a scan view instead of a long audit dump.
