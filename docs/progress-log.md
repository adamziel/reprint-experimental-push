...
- Trend: the visible page, this log, and the newest supervisor note stay aligned; the public page keeps the scan summary compact and points at linked evidence.
