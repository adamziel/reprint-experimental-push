...
- Last update: 2026-05-25 03:18:02 CEST.
- Status: Lab/model evidence still holds; production proof is still blocked by missing evidence.
- Trend: the visible page, this log, and the newest supervisor note stay aligned; the public page stayed compact and keeps older history behind details.
