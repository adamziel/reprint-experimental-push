...
- Last update: 2026-05-25 07:21:42 CEST.
- Status: blocked; the visible page, log, and latest audit note still line up.
- Trend: still no production evidence delta; the public surfaces now keep the blocked state and proof trail link-first.
