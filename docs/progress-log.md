...
- Last update: 2026-05-25 09:04:12 CEST.
- Status: blocked; the visible page, log, and latest audit note still line up.
- Trend: no evidence delta; the public wording stays tight, scan-first, and linked.
...
- Audit note: [audits/supervisor-note-20260525-090412.md](../audits/supervisor-note-20260525-090412.md) captures the latest scan pass in one screen.
