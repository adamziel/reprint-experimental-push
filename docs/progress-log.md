...
- Audit note: [audits/supervisor-note-20260525-123826.md](../audits/supervisor-note-20260525-123826.md) captures the newest same-state decision; the release state still does not move.
