...
- Public page: [progress.html](../progress.html) carries the visible update
  date, stays one-screen, and links the detailed evidence instead of embedding
  the full audits.
- Lane note: this update becomes visible on GitHub Pages only after the lane is
  merged to `main`.
