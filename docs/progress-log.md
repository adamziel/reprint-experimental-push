...
- Last update: 2026-05-25 03:17:14 CEST.
- Status: Lab/model evidence still holds; production proof is still blocked by missing evidence.
- Trend: the visible page, this log, and the newest supervisor note stay aligned; the public page stayed compact, kept the merge note to one line, and pushed older history behind details.
