...
- Last update: 2026-05-25 00:58 CEST.
...
- Visible page: `progress.html` shows the blocked state without a production
  proof count and links to this log for the evidence trail.
