...
- Last update: 2026-05-25 03:01:00 CEST.
- Status: Lab/model evidence still holds; production proof is still missing.
- Trend: the visible page, this log, and the newest supervisor note stay aligned; the public page now points at linked evidence first instead of repeating the same gate text in the summary.
