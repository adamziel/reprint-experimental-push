...
- Last update: 2026-05-25 02:56:55 CEST.
- Status: Lab/model evidence still holds; production proof is still missing.
- Trend: the visible page, this log, and the newest supervisor note stay aligned; the public page is shorter and still links out to the detailed trail.
