...
- Audit note: [audits/supervisor-note-20260525-122700.md](../audits/supervisor-note-20260525-122700.md) captures the newest same-state decision; the release state still does not move.
