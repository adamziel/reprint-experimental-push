...
- [ ] RPP-0294 (Near-Mid / merge-invariants) Carry through the release verifier for already-in-sync decision, variant 5. Success: scenario matrix row names the behavior and command.
