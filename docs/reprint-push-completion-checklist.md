...
- [ ] RPP-0091 (Near / release-gates) Carry through the release verifier for preflight route identity proof, variant 5. Success: checked command exits with the named code and no mutation attempt.
