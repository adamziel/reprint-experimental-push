...
- Special file entries such as symlinks, junctions, reparse-like objects,
  sockets, FIFOs, hard links, and device-like objects are unsupported and
  must stop rather than being treated as ordinary files.
