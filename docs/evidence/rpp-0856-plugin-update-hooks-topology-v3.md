# RPP-0856 Plugin Update Hooks Topology Variant 3

Date: 2026-06-01

## Scope

RPP-0856 records deterministic generated coverage for plugin update hook
topology variant 3. Success for this slice is bounded to the topology command
contract: the command must either start the Docker WordPress sites or record the
exact unavailable capability that prevented startup.
...
```json
{
  ...
  "candidateScope": {
    "status": "plugin-update-hooks-topology-candidate-v3",
    "supportOnly": true,
    "productionBacked": false,
    "releaseEligible": false,
    ...
    "candidateClaims": [
      ...
      "variant-3-release-block-contract-recorded",
  ...
  "topologyCommand": {
    ...
    "artifactHash": "sha256:df21f21afba2e4e698fa5cd1add77d6acc065a45e9d3769006b766c4d6bac3af"
  },
  "releaseReadyScope": {
  ...
  "scopeComparisonHash": "8679c05f2680073b4c7c79da161947d93d6c87cb66719c0b20149ddde8bcde5b",
  "validation": {
    "commands": [
      {
        "command": "node --check test/rpp-0856-plugin-update-hooks-topology-v3.test.js",
        "result": "exit-0"
      },
      {
        "command": "node --test test/rpp-0856-plugin-update-hooks-topology-v3.test.js",
        "result": "exit-0"
      },
      {
        "command": "npm run verify:release:docker-local-production",
      ...
      {
        "command": "node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0856-plugin-update-hooks-topology-v3.md",
        "result": "exit-0"
      },
      {
...
```sh
node --check test/rpp-0856-plugin-update-hooks-topology-v3.test.js
node --test test/rpp-0856-plugin-update-hooks-topology-v3.test.js
npm run verify:release:docker-local-production
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0856-plugin-update-hooks-topology-v3.md
git diff --check
```

Observed local results after implementation:

- `node --check test/rpp-0856-plugin-update-hooks-topology-v3.test.js`: exit 0
- `node --test test/rpp-0856-plugin-update-hooks-topology-v3.test.js`: 5 subtests passed, 0 failed
