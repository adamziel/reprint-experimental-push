# AO Progress Report - 2026-05-28 22:38 CEST
...
- `docs/reprint-push-completion-checklist.md` contains exactly 1000
  near-to-far `RPP-0001` through `RPP-1000` items. After this update, 221 are
  checked from integrated evidence and 779 remain open.
...
- Release gates: `RPP-0001` through `RPP-0089`.
