# AO Progress Report - 2026-05-28 09:18 CEST
...
- `node --test test/progress-html-release-timestamp.test.js test/release-gates-status-row.test.js` — 2 pass / 0 fail for the post-RPP-0230 live-roster 26 progress heartbeat sanity check.
...
| --- | --- | --- |
| `rpp-24` | developer | Active generated-harness work is `RPP-0138`, not lane-counted. |
| `rpp-25` | developer | Active release-gate work is `RPP-0060`; `RPP-0052` through `RPP-0059` remain session-only/queued and not lane-counted on `5057ee38a`. |
| `rpp-26` | progress reporter | Prior progress branch was already folded into lane truth where integrated; no current tmux session is active. |
| `rpp-28` | integrator | `RPP-0230` is integrated on origin/lane; visible follow-up integration work for `RPP-0231`/`RPP-0232` remains session-only until origin/lane moves. |
| `rpp-29` | developer | Active merge-invariant work is `RPP-0233`, not lane-counted. |
| `rpp-30` | developer | Active graph work is `RPP-0341`, not lane-counted. |
...
| `rpp-33` | developer | Active generated-harness work is `RPP-0139`, not lane-counted. |
| `rpp-34` | developer | Active plugin-driver work is `RPP-0452`, not lane-counted. |
...
Lane truth after fetch is `5057ee38a` with 122 checked and 878 open. `RPP-0230`
is integrated and counted. `RPP-0231`, `RPP-0232`, `RPP-0233`, `RPP-0052`
through `RPP-0060`, `RPP-0138`, `RPP-0139`, `RPP-0341`, `RPP-0452`,
`RPP-0453`, plus other session-only work are not counted until origin/lane
moves again and the evidence is integrated.

| Slice | Visible ref / session | Heartbeat posture |
| --- | --- | --- |
| `RPP-0052`-`RPP-0060` | release-gate refs / `rpp-25` | active or queued release-gate branches, not lane-counted |
| `RPP-0138`, `RPP-0139` | generated-harness refs / `rpp-24`, `rpp-33` | generated work, not lane-counted |
| `RPP-0231`-`RPP-0233` | merge-invariant refs / `rpp-28`, `rpp-29` | active integration/developer work, not lane-counted |
| `RPP-0341` | graph refs / `rpp-30` | graph work, not lane-counted |
| `RPP-0452`, `RPP-0453` | plugin-driver refs / `rpp-34`, `rpp-32` | active plugin-driver work, not lane-counted |
