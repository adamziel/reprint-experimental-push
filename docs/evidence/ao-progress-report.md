# AO Progress Report - 2026-05-28 14:35 CEST
...
evidence provenance root branch). It separates
...
| --- | --- | --- |
| `rpp-24` | developer | Root release provenance branch ancestry is preserved by `6194b0bd`; `RPP-0101` through `RPP-0104`, `RPP-0107`, and `RPP-0112` are integrated; current visible generated graph targets remain branch-local until tested and integrated. |
