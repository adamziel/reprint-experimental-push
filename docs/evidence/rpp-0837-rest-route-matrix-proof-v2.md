# RPP-0837 REST Route Matrix Proof Variant 2

Date: 2026-06-01

## Scope

RPP-0837 records variant 2 support-only evidence for the REST route matrix
proof required by the production topology lane. It follows the RPP-0817 route
matrix contract and the current topology evidence pattern for exact unavailable
capability, hash/count/surface-only evidence, local-only ingress, and no
packaged fallback.
...
```json
{
  ...
  "rppId": "RPP-0837",
  "variant": 2,
  "title": "REST route matrix proof on production topology variant 2",
  ...
  "builtOn": {
    "routeMatrixContract": {
      ...
      "variantLineage": "RPP-0817-variant-1"
    },
    "topologyCommand": {
  ...
  "validation": {
    "commands": [
      {
        "command": "node --check test/rpp-0837-rest-route-matrix-proof-v2.test.js",
        "result": "exit-0"
      },
      {
        "command": "node --test --test-name-pattern RPP-0837 test/rpp-0837-rest-route-matrix-proof-v2.test.js",
        "result": "exit-0"
      },
      {
        "command": "node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0837-rest-route-matrix-proof-v2.md",
        "result": "exit-0"
      },
      {
...
```sh
node --check test/rpp-0837-rest-route-matrix-proof-v2.test.js
node --test --test-name-pattern RPP-0837 test/rpp-0837-rest-route-matrix-proof-v2.test.js
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0837-rest-route-matrix-proof-v2.md
