# RPP-0685 claim expiry policy variant 5 evidence
...
- Added standalone coverage in
  `test/rpp-0685-claim-expiry-policy-v5.test.js`.
...
```bash
node --check test/rpp-0685-claim-expiry-policy-v5.test.js
...
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0685-claim-expiry-policy-v5.md
git diff --check
...
- Focused RPP-0685 test passed 1 subtest, 0 failures.
- Adjacent RPP-0665 variant-4 proof passed 1 subtest, 0 failures.
- Adjacent RPP-0645 variant-3 proof passed 1 subtest, 0 failures.
- RPP-0625 SQLite expiry proof passed all selected subtests.
