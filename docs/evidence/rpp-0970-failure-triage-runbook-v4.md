...
risks carried through the RPP-0950 v3 contract and 18 final-release risks from
...
| Final-scope release-gate evaluator | `node scripts/release/check-release-gates.mjs --scope final-release --now 2026-06-01T03:55:00.000Z` | exit `1`, final release `NO-GO`, 18 blocking final-release risks, no mutation |
