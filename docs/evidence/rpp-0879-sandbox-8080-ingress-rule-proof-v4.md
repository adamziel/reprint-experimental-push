# RPP-0879 Sandbox 8080 Ingress Rule Proof Variant 4

Date: 2026-06-01
Lane: RPP-0879 sandbox 8080 ingress rule proof, variant 4
Final release posture: `NO-GO`

## Scope

RPP-0879 records generated support-only evidence for the sandbox HTTP ingress
rule used by the Docker local WordPress topology. It uses RPP-0859 variant 3
as the closest ingress-proof template and reads the variant-4 production
topology patterns from RPP-0861, RPP-0862, and RPP-0863, with the RPP-0880
no-tunnel policy as the adjacent local-only pattern. This variant 4 report has
its own deterministic fixture namespace, plugin evidence hash, hashes, and
...
```json
{
  ...
  "variant4Distinctives": {
    ...
    "deterministicFixtureNamespace": "RPP-0879-variant-4",
  ...
  "candidateScope": {
    ...
    "importExportSurvivalSurface": {
      ...
      "requiredPluginEvidence": {
        ...
        "resourceKeyHash": "76d8b1eede118b7d9d85aaf0df2f3b53613ef6134fb27e895a0965b2660ca41b",
  ...
  "topologyCommand": {
    ...
    "artifactHash": "sha256:e6b360372bfd16dd0886d3bed5eacd540c43367f0ee35a02ab2c96fbb3dd0453"
  },
  ...
  "scopeComparisonHash": "sha256:27b0d08e78be9a92f9ff0931542e0b1b9719019c5dbfc36c61378ce2219242f4",
  "proofHash": "sha256:bf32eac59f8474f041c8a74cd7c4803a6651adcadbd37b4ce42e58e7055d6d3a"
}
```
...
Release-ready RPP-0879 evidence still requires a Docker-capable or equivalent
...
```sh
node --check test/rpp-0879-sandbox-8080-ingress-rule-proof-v4.test.js
node --test --test-name-pattern RPP-0879 test/rpp-0879-sandbox-8080-ingress-rule-proof-v4.test.js
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0879-sandbox-8080-ingress-rule-proof-v4.md
git diff --check
```
