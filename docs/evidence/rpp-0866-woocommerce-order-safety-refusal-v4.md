# RPP-0866 WooCommerce order safety refusal v4 evidence

Date: 2026-06-01
Lane: RPP-0866 WooCommerce order safety refusal, variant 4
Checklist item: RPP-0866 - WooCommerce order safety refusal.
...
`test/rpp-0866-woocommerce-order-safety-refusal-v4.test.js` builds an active
...
```sh
node --check test/rpp-0866-woocommerce-order-safety-refusal-v4.test.js
node --test --test-name-pattern RPP-0866 test/rpp-0866-woocommerce-order-safety-refusal-v4.test.js
npm run verify:release:docker-local-production
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0866-woocommerce-order-safety-refusal-v4.md
git diff --check
```
