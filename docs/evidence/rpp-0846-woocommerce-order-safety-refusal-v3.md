# RPP-0846 WooCommerce order safety refusal v3 evidence

Date: 2026-06-01
Lane: RPP-0846 WooCommerce order safety refusal, variant 3
Checklist item: RPP-0846 - WooCommerce order safety refusal.
...
`test/rpp-0846-woocommerce-order-safety-refusal-v3.test.js` builds an active
...
```sh
node --check test/rpp-0846-woocommerce-order-safety-refusal-v3.test.js
node --test test/rpp-0846-woocommerce-order-safety-refusal-v3.test.js
npm run verify:release:docker-local-production
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0846-woocommerce-order-safety-refusal-v3.md
git diff --check
```
