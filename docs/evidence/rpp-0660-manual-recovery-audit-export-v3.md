# RPP-0660 manual recovery audit export, variant 3
...
- Added `test/rpp-0660-manual-recovery-audit-export-v3.test.js`.
...
```bash
node --check test/rpp-0660-manual-recovery-audit-export-v3.test.js
...
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0660-manual-recovery-audit-export-v3.md
git diff --check
