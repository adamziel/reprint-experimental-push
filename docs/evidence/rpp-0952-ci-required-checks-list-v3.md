# RPP-0952 CI required checks list v3 evidence

Date: 2026-06-01
Variant: 3
Audited local branch: `session/rpp-952`
Audited lane head before this evidence file: `13eae74ae2ef57694c188e009e2d3623012683a6`
Scope: support-only CI required checks list v3

This evidence records the CI required checks list v3 release-gate discipline.
...
```json
{
  ...
  "rppId": "RPP-0952",
  "sliceId": "RPP-0952",
  "proofId": "rpp-0952-ci-required-checks-list-v3",
  "variant": 3,
  "generatedAt": "2026-06-01T03:09:00.000Z",
  "auditedBranch": "session/rpp-952",
  "auditedLaneHeadBeforeEvidence": "13eae74ae2ef57694c188e009e2d3623012683a6",
  "status": "support-only-ci-required-checks-list-v3-recorded",
  "supportOnly": true,
  ...
  "evidenceLimits": {
    "mode": "support-only-ci-required-checks-list-v3",
    "mutationAttempted": false,
  ...
  "validationCommands": [
    {
      ...
      "expectedExit": 0,
      "observed": "13eae74ae2ef57694c188e009e2d3623012683a6 before adding this evidence"
    },
    {
    ...
    {
      "command": "node --test --test-name-pattern RPP-0952 test/rpp-0952-ci-required-checks-list-v3.test.js",
      "expectedExit": 0,
      "observed": "Focused RPP-0952 tests pass"
    },
    {
      "command": "node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0952-ci-required-checks-list-v3.md",
      "expectedExit": 0,
...
RPP-0952 is support-only CI required-check evidence. Every listed CI/release
check remains blocking, and every check requires fresh production-backed
observations before release-gate status movement. Missing production-backed
proof and failed required proof both fail closed. This artifact provides only
support evidence, so it cannot move a gate from `support_only` toward
`partially_proven`, `proven`, or `GO`.
...
support evidence for the RPP-0952 CI required checks list v3 until fresh
