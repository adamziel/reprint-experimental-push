# RPP-0855 Plugin Activation Hooks Topology Variant 3

Date: 2026-06-01

## Scope

RPP-0855 records a third activation-hook topology proof using the same
candidate-scope pattern as RPP-0835. This is deterministic local support-only
...
```json
{
  ...
  "rppId": "RPP-0855",
  "variant": 3,
  "title": "Plugin activation hooks topology candidate scope variant 3",
  ...
  "candidateScope": {
    "status": "activation-hook-topology-candidate-v3",
    "sourcePattern": "rpp-0835-candidate-scope",
    "supportOnly": true,
    "productionBacked": false,
    "releaseEligible": false,
  ...
  "scopeComparisonHash": "e6989247d448dadbcef2ef0845da434e3877ae7c666f5b7132130fbb5f168d66"
}
```
...
```sh
node --check test/rpp-0855-plugin-activation-hooks-topology-v3.test.js
node --test test/rpp-0855-plugin-activation-hooks-topology-v3.test.js
node --test --test-name-pattern "activation hook" test/production-shaped-proof.test.js
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0855-plugin-activation-hooks-topology-v3.md
git diff --check
```
