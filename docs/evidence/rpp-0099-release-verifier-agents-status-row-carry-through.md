...
- Scenario matrix: `dishonest-release-verdict` fails closed at `20/21`; generated `0/4` row passes the row gate and leaves release movement held only by provenance.
