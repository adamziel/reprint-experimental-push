...
- The proof then scans all 620 deterministic generated harness cases and covers
  1,795 `keep-remote` decisions across 542 cases.
- Covered generated decision resources include 316 files, 20 plugins, and 1,459
  rows. Remote change shapes are 624 creates, 20 deletes, and 1,151 updates.
- Ready apply preservation is checked for 816 ready-plan `keep-remote`
