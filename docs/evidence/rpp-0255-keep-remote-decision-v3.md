...
- The proof then scans all 620 deterministic generated harness cases and covers
  1,845 `keep-remote` decisions across 544 cases.
- Covered generated decision resources include 316 files, 20 plugins, and 1,509
  rows. Remote change shapes are 664 creates, 30 deletes, and 1,151 updates.
- Ready apply preservation is checked for 836 ready-plan `keep-remote`
