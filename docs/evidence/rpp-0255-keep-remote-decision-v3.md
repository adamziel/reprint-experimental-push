...
- The proof then scans all 620 deterministic generated harness cases and covers
  1,775 `keep-remote` decisions across 542 cases.
- Covered generated decision resources include 316 files, 20 plugins, and 1,439
  rows. Remote change shapes are 614 creates, 20 deletes, and 1,141 updates.
- Ready apply preservation is checked for 806 ready-plan `keep-remote`
