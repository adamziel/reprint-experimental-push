# RPP-0870 Multisite Subdomain Topology Variant 4

Date: 2026-06-01

## Scope

RPP-0870 records focused regression coverage for the multisite subdomain
topology candidate shape against the release-ready scope. This is deterministic
support evidence only. It follows the RPP-0850 variant-3 candidate-scope
pattern and keeps the candidate versus release-ready boundary explicit for
production topology readback, production import/export, auth/session lifecycle,
durable journal replay, release artifact, and release verifier requirements.
...
```json
{
  ...
  "rppId": "RPP-0870",
  "variant": 4,
  "title": "Multisite subdomain topology candidate scope v4",
  ...
  "productionImportExportEvidence": {
    ...
    "observedAttempt": "not-performed-in-rpp-0870",
  ...
  "candidateScope": {
    "status": "multisite-subdomain-topology-candidate-v4",
    "coverageMode": "focused-regression-candidate-vs-release-ready",
    "supportOnly": true,
    "productionBacked": false,
    "releaseEligible": false,
    "releaseGateMovement": "none",
    "sourcePattern": "local-static-external-wordpress-topology-derived-v4",
    "topologyShape": {
    ...
    "countEvidence": {
      ...
      "themeSurfaceCount": 4,
      "focusedRegressionSurfaceCount": 7,
    ...
    "surfaceEvidenceHash": "0d5a91b240807ed37b7293b944f316033dc5412bdb6f9b0b2eafad3911cfe499",
    "candidateClaims": [
  ...
  "scopeComparisonHash": "5f1c120f7cb719cf4d4cba15127ca1839e1cf3610a822a9d9002d9801e55ff0c"
}
```
...
regression gap surfaces, and no-go release-gate surfaces.
...
restart replay, release artifacts, or release verifier acceptance.
...
```sh
node --check test/rpp-0870-multisite-subdomain-topology-v4.test.js
node --test --test-name-pattern RPP-0870 test/rpp-0870-multisite-subdomain-topology-v4.test.js
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0870-multisite-subdomain-topology-v4.md
git diff --check
```

Observed local results after implementation:

- `node --check test/rpp-0870-multisite-subdomain-topology-v4.test.js`: exit 0
- `node --test --test-name-pattern RPP-0870 test/rpp-0870-multisite-subdomain-topology-v4.test.js`: exit 0
