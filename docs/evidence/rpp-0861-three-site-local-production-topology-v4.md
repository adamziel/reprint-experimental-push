# RPP-0861 three-site local production topology v4 evidence

Date: 2026-06-01
Lane: RPP-0861 three-site local production topology, variant 4
Checklist item: RPP-0861 - Add focused regression coverage for three-site local production topology, variant 4.

## Scope

This slice adds focused regression support evidence for the three primary
WordPress site topology. It only adds the focused RPP-0861 test and this
...
Success for this variant follows the RPP-0801, RPP-0821, and RPP-0841
...
`wp-apply-revalidation-source`. RPP-0861 records that role as support surface
...
- artifact: `/tmp/reprint-docker-local-production-evidence-x8RtXv/release-gate-input.json`
...
`test/rpp-0861-three-site-local-production-topology-v4.test.js` builds a
deterministic RPP-0861 proof from the existing Docker topology artifact helpers.
It verifies:
...
```sh
node --check test/rpp-0861-three-site-local-production-topology-v4.test.js
node --test test/rpp-0861-three-site-local-production-topology-v4.test.js
npm run verify:release:docker-local-production
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0861-three-site-local-production-topology-v4.md
git diff --check
```
...
- syntax check: exit `0`
- focused RPP-0861 test: exit `0`, 5 tests passed
