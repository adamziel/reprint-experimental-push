# RPP-0960 go/no-go release decision record v3 evidence

Date: 2026-06-01
Audited local branch: `session/rpp-960`
Audited lane head before this evidence file: `f055e243ecd8ed82033ca4fc20a114ef2f531df7`
Checklist item: RPP-0960 - go/no-go release decision record, variant 3.
...
```json
{
  "schemaVersion": 1,
  "rppId": "RPP-0960",
  "proofId": "rpp-0960-go-no-go-release-decision-record-v3",
  "variant": 3,
  ...
  "evidencePath": "docs/evidence/rpp-0960-go-no-go-release-decision-record-v3.md",
  "generatedAt": "2026-06-01T03:35:00.000Z",
  "auditedBranch": "session/rpp-960",
  "auditedHeadBeforeEvidence": "f055e243ecd8ed82033ca4fc20a114ef2f531df7",
  "releaseGateCommand": "node scripts/release/check-release-gates.mjs --scope final-release --now 2026-06-01T03:35:00.000Z",
  "releaseGateSnapshot": {
    "exitCode": 1,
    "releaseStatus": "NO-GO",
  ...
  "validation": [
    "node --check test/rpp-0960-go-no-go-release-decision-record-v3.test.js",
    "node --test --test-name-pattern RPP-0960 test/rpp-0960-go-no-go-release-decision-record-v3.test.js",
    "node scripts/release/artifact-redaction-scan.mjs docs/release/go-no-go-release-decision-record.md docs/evidence/rpp-0960-go-no-go-release-decision-record-v3.md",
    "git diff --check"
  ]
}
```
...
| --- | --- | --- |
| Audited commit | `git rev-parse HEAD` | `f055e243ecd8ed82033ca4fc20a114ef2f531df7` before adding this evidence |
| Final-scope release-gate evaluator | `node scripts/release/check-release-gates.mjs --scope final-release --now 2026-06-01T03:35:00.000Z` | exit `1`, final release `NO-GO`, 17 blocking risks, no mutation |
| Focused RPP-0960 regression | `node --test --test-name-pattern RPP-0960 test/rpp-0960-go-no-go-release-decision-record-v3.test.js` | decision and evidence records name all remaining risks and keep them open |
| Artifact redaction scan | `node scripts/release/artifact-redaction-scan.mjs docs/release/go-no-go-release-decision-record.md docs/evidence/rpp-0960-go-no-go-release-decision-record-v3.md` | no raw URLs, credentials, cookies, payloads, or private values |
