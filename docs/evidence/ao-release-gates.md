...
Date: 2026-05-28
Lane: release-gates
Primary checklist range: RPP-0001 through RPP-0026, plus RPP-0028, RPP-0030, RPP-0031, RPP-0032, RPP-0033, RPP-0034, RPP-0035, RPP-0036, RPP-0037, RPP-0038, RPP-0039, RPP-0040, RPP-0050, RPP-0051, and RPP-0056
...
| RPP-0056 | Evidence toward variant-3 releaseMovement allowed/denied summary now generates denied and allowed final-release fixtures, proving the denied command exits `1` with `SAME_SOURCE_IDENTITY_REQUIRED`, the allowed summary stays `NO-GO` with `PRODUCTION_EVIDENCE_REQUIRED`, and both reports preserve `mutationAttempted: false`. |

## Focused verification

```sh
node --test test/release-gate-release-movement-summary-generated.test.js test/release-gate-preflight-route-identity-generated.test.js test/release-gate-same-source-generated.test.js test/verify-release-failure-reason.test.js test/progress-html-release-timestamp.test.js test/release-gates-status-row.test.js test/release-gates.test.js test/release-gate-cli.test.js
```
...
Generated releaseMovement summary proof:

- Command: `node --test test/release-gate-release-movement-summary-generated.test.js test/release-gates.test.js test/release-gate-cli.test.js`
- Observed status: `pass`; generated fixtures compare denied source-identity drift with allowed final-release evidence that still lacks production provenance.
- Evidence link: the denied fixture exits `1` with `SAME_SOURCE_IDENTITY_REQUIRED`, exact `releaseMovement.allowed: false` and `finalGates: "19/20"`, a `[release-gates-ci:held final=19/20 candidate=19/20 reason=SAME_SOURCE_IDENTITY_REQUIRED]` marker, exact summary-gate evidence, and `mutationAttempted: false`; the allowed fixture exits `1` with `PRODUCTION_EVIDENCE_REQUIRED`, exact `releaseMovement.allowed: true` and `finalGates: "20/20"`, a release-ready status marker, `NO-GO`, and `mutationAttempted: false`.
...
- Generated releaseMovement summary coverage now asserts the same denied/allowed matrix from fixture-backed CLI commands: denied exits `1` with `SAME_SOURCE_IDENTITY_REQUIRED`; allowed exits `1` with `PRODUCTION_EVIDENCE_REQUIRED`, remains `NO-GO`, and preserves exact summary evidence plus `mutationAttempted: false`.
