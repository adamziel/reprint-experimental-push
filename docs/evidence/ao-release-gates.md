...
Date: 2026-05-28
Lane: release-gates
Primary checklist range: RPP-0001 through RPP-0026, plus RPP-0028, RPP-0030, RPP-0031, RPP-0032, RPP-0033, RPP-0034, RPP-0035, RPP-0036, RPP-0037, RPP-0038, RPP-0039, RPP-0040, RPP-0050, RPP-0051, and RPP-0061
...
| RPP-0061 | Evidence toward variant-4 missing `REPRINT_PUSH_SOURCE_URL` coverage now runs the release-gate CLI with every other final-release gate satisfied, proving exit `1`, exact `REPRINT_PUSH_LIVE_SOURCE_REQUIRED` evidence, `NO-GO`, secret redaction, and `mutationAttempted: false`. |

## Focused verification

```sh
node --test test/release-gate-missing-source-url-regression.test.js test/release-gate-preflight-route-identity-generated.test.js test/release-gate-same-source-generated.test.js test/verify-release-failure-reason.test.js test/progress-html-release-timestamp.test.js test/release-gates-status-row.test.js test/release-gates.test.js test/release-gate-cli.test.js
```
...
Missing source URL regression proof:

- Command: `node --test test/release-gate-missing-source-url-regression.test.js test/release-gates.test.js test/release-gate-cli.test.js`
- Observed status: `pass`; generated fixture supplies every other final-release gate while leaving `REPRINT_PUSH_SOURCE_URL` empty.
- Evidence link: the checked CLI exits `1` with `REPRINT_PUSH_LIVE_SOURCE_REQUIRED`, `finalGates: "19/20"`, exact `source-url` evidence, `[release-gates-ci:held final=19/20 candidate=19/20 reason=REPRINT_PUSH_LIVE_SOURCE_REQUIRED]`, `NO-GO`, redacted secret output, and `mutationAttempted: false`.
...
- Generated missing source URL regression coverage now isolates the `source-url` gate with all other final-release evidence satisfied and proves `REPRINT_PUSH_LIVE_SOURCE_REQUIRED`, exact missing-source evidence, `NO-GO`, redacted production secret output, and `mutationAttempted: false`.
