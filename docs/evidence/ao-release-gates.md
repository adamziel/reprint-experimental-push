...
Date: 2026-05-28
Lane: release-gates
Primary checklist range: RPP-0001 through RPP-0026, plus RPP-0028, RPP-0030, RPP-0031, RPP-0032, RPP-0033, RPP-0034, RPP-0035, RPP-0036, RPP-0037, RPP-0038, RPP-0039, RPP-0040, and RPP-0048
...
| RPP-0048 | Evidence toward variant-3 Application Password credential binding now generates matching and mismatched final-release fixtures, asserts source/user-bound evidence on the matching fixture, and proves source/user drift exits `1` with `APPLICATION_PASSWORD_BINDING_REQUIRED`, exact binding evidence, final bracketed status marker, and `mutationAttempted: false`. |

## Focused verification

```sh
node --test test/release-gate-application-password-binding-generated.test.js test/verify-release-failure-reason.test.js test/progress-html-release-timestamp.test.js test/release-gates-status-row.test.js test/release-gates.test.js test/release-gate-cli.test.js
```
...
Generated Application Password binding proof:

- Command: `node --test test/release-gate-application-password-binding-generated.test.js test/release-gates.test.js test/release-gate-cli.test.js`
- Observed status: `pass`; generated fixtures supply every other final-release gate while comparing matching and mismatched Application Password source/user binding evidence.
- Evidence link: the matching fixture preserves exact source/user-bound evidence and remains `NO-GO` without provenance; the mismatched fixture exits `1` with `APPLICATION_PASSWORD_BINDING_REQUIRED`, `finalGates: "19/20"`, exact `application-password-binding` drift evidence, `[release-gates-ci:held final=19/20 candidate=19/20 reason=APPLICATION_PASSWORD_BINDING_REQUIRED]`, and `mutationAttempted: false`.
...
- Generated Application Password binding coverage now records matching source/user-bound evidence and a mismatched source/user fixture that fails closed at `application-password-binding` only, with `APPLICATION_PASSWORD_BINDING_REQUIRED`, a `[release-gates-ci:held final=19/20 candidate=19/20 reason=APPLICATION_PASSWORD_BINDING_REQUIRED]` marker, exact drift evidence, and `mutationAttempted: false`.
