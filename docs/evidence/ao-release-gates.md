...
Date: 2026-05-28
Lane: release-gates
Primary checklist range: RPP-0001 through RPP-0026, plus RPP-0028, RPP-0030, RPP-0031, RPP-0032, RPP-0033, RPP-0034, RPP-0035, RPP-0036, RPP-0037, RPP-0038, RPP-0039, RPP-0040, RPP-0050, RPP-0051, RPP-0058, and RPP-0063
...
| RPP-0063 | Evidence toward variant-4 missing `REPRINT_PUSH_REMOTE_CHANGED_URL` coverage now runs the release-gate CLI with every other final-release gate supplied, asserting exit `1`, exact `REPRINT_PUSH_REMOTE_CHANGED_URL_REQUIRED` reason/evidence, `NO-GO`, redaction, and `mutationAttempted: false`. |

## Focused verification

```sh
node --test test/release-gate-missing-remote-changed-url-regression.test.js test/release-gate-progress-release-timestamp-generated.test.js test/release-gate-preflight-route-identity-generated.test.js test/release-gate-same-source-generated.test.js test/verify-release-failure-reason.test.js test/progress-html-release-timestamp.test.js test/release-gates-status-row.test.js test/release-gates.test.js test/release-gate-cli.test.js
```
...
Missing remote-changed URL regression proof:

- Command: `node --test test/release-gate-missing-remote-changed-url-regression.test.js test/release-gates.test.js test/release-gate-cli.test.js`
- Observed status: `pass`; generated fixture supplies source URL, local URL, credentials, and every non-topology final-release gate while leaving `REPRINT_PUSH_REMOTE_CHANGED_URL` empty.
- Evidence link: the checked command exits `1` with `REPRINT_PUSH_REMOTE_CHANGED_URL_REQUIRED`, `finalGates: "19/20"`, exact `remote-changed-url` reason/evidence, `[release-gates-ci:held final=19/20 candidate=19/20 reason=REPRINT_PUSH_REMOTE_CHANGED_URL_REQUIRED]`, `NO-GO`, redacted credential output, and `mutationAttempted: false`.
...
- Missing remote-changed URL regression coverage now records a final-release fixture where every other gate is supplied but `REPRINT_PUSH_REMOTE_CHANGED_URL` is empty; the checked CLI exits nonzero with `REPRINT_PUSH_REMOTE_CHANGED_URL_REQUIRED`, exact `remote-changed-url` reason/evidence, `NO-GO`, redacted credentials, and `mutationAttempted: false`.
