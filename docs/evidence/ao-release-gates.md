...
Date: 2026-05-28
Lane: release-gates
Primary checklist range: RPP-0001 through RPP-0026, plus RPP-0028, RPP-0030, RPP-0031, RPP-0032, RPP-0033, RPP-0034, RPP-0035, RPP-0036, RPP-0037, RPP-0038, RPP-0039, RPP-0040, and RPP-0052
...
| RPP-0052 | Evidence toward variant-3 dry-run route eligibility proof now generates eligible and rejected final-release fixtures, asserts exact route eligibility evidence on the eligible fixture, and proves dry-run rejection exits `1` with `DRY_RUN_ROUTE_ELIGIBILITY_REQUIRED`, exact reason/evidence, held marker, and `mutationAttempted: false`. |

## Focused verification

```sh
node --test test/release-gate-dry-run-route-eligibility-generated.test.js test/verify-release-failure-reason.test.js test/progress-html-release-timestamp.test.js test/release-gates-status-row.test.js test/release-gates.test.js test/release-gate-cli.test.js
```
...
Generated dry-run route eligibility proof:

- Command: `node --test test/release-gate-dry-run-route-eligibility-generated.test.js test/release-gates.test.js test/release-gate-cli.test.js`
- Observed status: `pass`; generated fixtures supply every other final-release gate while comparing eligible and rejected dry-run route evidence before apply.
- Evidence link: the eligible fixture preserves exact route eligibility evidence and remains `NO-GO` without provenance; the rejected fixture exits `1` with `DRY_RUN_ROUTE_ELIGIBILITY_REQUIRED`, `finalGates: "19/20"`, exact `dry-run-route-eligibility` reason/evidence, `[release-gates-ci:held final=19/20 candidate=19/20 reason=DRY_RUN_ROUTE_ELIGIBILITY_REQUIRED]`, and `mutationAttempted: false`.
...
- Generated dry-run route eligibility coverage now records matching final-release route eligibility evidence and a rejected dry-run fixture that fails closed at `dry-run-route-eligibility` only, with `DRY_RUN_ROUTE_ELIGIBILITY_REQUIRED`, a `[release-gates-ci:held final=19/20 candidate=19/20 reason=DRY_RUN_ROUTE_ELIGIBILITY_REQUIRED]` marker, exact evidence, and `mutationAttempted: false`.
