...
Date: 2026-05-28
Lane: release-gates
Primary checklist range: RPP-0001 through RPP-0026, plus RPP-0028, RPP-0030, RPP-0031, RPP-0032, RPP-0033, RPP-0034, RPP-0035, RPP-0036, RPP-0037, RPP-0038, RPP-0039, RPP-0040, RPP-0050, RPP-0051, and RPP-0057
...
| RPP-0057 | Evidence toward variant-3 tmux stdout proof status marker now generates bracketed and malformed marker fixtures, asserting exact `TMUX_STATUS_MARKER_REQUIRED` evidence on rejection, the final marker text on the bracketed path, `NO-GO`, and `mutationAttempted: false`. |

## Focused verification

```sh
node --test test/release-gate-tmux-status-marker-generated.test.js test/release-gate-preflight-route-identity-generated.test.js test/release-gate-same-source-generated.test.js test/verify-release-failure-reason.test.js test/progress-html-release-timestamp.test.js test/release-gates-status-row.test.js test/release-gates.test.js test/release-gate-cli.test.js
```
...
Generated tmux stdout proof status marker:

- Command: `node --test test/release-gate-tmux-status-marker-generated.test.js test/release-gates.test.js test/release-gate-cli.test.js`
- Observed status: `pass`; generated fixtures compare a malformed tmux marker with a final bracketed marker captured from the checked release-gate command.
- Evidence link: the malformed marker fixture exits `1` with `TMUX_STATUS_MARKER_REQUIRED`, exact `tmux-status-marker` reason/evidence, `[release-gates-ci:held final=19/20 candidate=19/20 reason=TMUX_STATUS_MARKER_REQUIRED]`, and `mutationAttempted: false`; the bracketed marker fixture emits `[release-gates-ci:release-ready final=20/20 candidate=20/20 reason=all-release-gates-are-backed-by-final-release-evidence]`, remains `NO-GO` without provenance, and preserves exact final marker evidence.
...
- Generated tmux stdout proof status marker coverage now records exact malformed-marker rejection evidence (`TMUX_STATUS_MARKER_REQUIRED`) and exact final bracketed marker evidence while preserving `NO-GO` and `mutationAttempted: false`.
