...
Date: 2026-05-28
Lane: release-gates
Primary checklist range: RPP-0001 through RPP-0026, plus RPP-0028, RPP-0030, RPP-0031, RPP-0032, RPP-0033, RPP-0034, RPP-0035, RPP-0036, RPP-0037, RPP-0038, RPP-0039, RPP-0040, RPP-0050, RPP-0051, RPP-0058, RPP-0062, and RPP-0068
...
| RPP-0068 | Evidence toward variant-4 Application Password credential binding now runs the release-gate CLI with every other final-release gate supplied, asserting exit `1`, exact `APPLICATION_PASSWORD_BINDING_REQUIRED` source/user binding evidence, final held marker, `NO-GO`, redaction, and `mutationAttempted: false`. |

## Focused verification

```sh
node --test test/release-gate-application-password-binding-regression.test.js test/release-gate-missing-local-url-regression.test.js test/release-gate-progress-release-timestamp-generated.test.js test/release-gate-preflight-route-identity-generated.test.js test/release-gate-same-source-generated.test.js test/verify-release-failure-reason.test.js test/progress-html-release-timestamp.test.js test/release-gates-status-row.test.js test/release-gates.test.js test/release-gate-cli.test.js
```
...
Application Password credential binding regression proof:

- Command: `node --test test/release-gate-application-password-binding-regression.test.js test/release-gates.test.js test/release-gate-cli.test.js`
- Observed status: `pass`; generated fixture supplies source/local/remote URLs, production credentials, and every non-binding final-release gate while the Application Password binding evidence points to a forged source URL and different user.
- Evidence link: the checked command exits `1` with `APPLICATION_PASSWORD_BINDING_REQUIRED`, `finalGates: "19/20"`, exact `application-password-binding` source/user reason/evidence, `[release-gates-ci:held final=19/20 candidate=19/20 reason=APPLICATION_PASSWORD_BINDING_REQUIRED]`, `NO-GO`, redacted credential output, and `mutationAttempted: false`.
...
- Application Password credential binding regression coverage now records a final-release fixture where every other gate is supplied but the Application Password binding belongs to a forged source URL and different user; the checked CLI exits nonzero with `APPLICATION_PASSWORD_BINDING_REQUIRED`, exact `application-password-binding` source/user evidence, `NO-GO`, redacted credentials, and `mutationAttempted: false`.
