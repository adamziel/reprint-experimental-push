# RPP-0880 No Tunnel Policy Proof Variant 4

Date: 2026-06-01

## Scope

RPP-0880 records deterministic local support-only evidence for the remote-tunnel
prohibition. It follows the RPP-0860 no-tunnel policy variant-3 pattern by
...
```json
{
  "schemaVersion": 1,
  "rppId": "RPP-0880",
  "proofId": "rpp-0880-no-tunnel-policy-proof-v4",
  "variant": 4,
  ...
  "candidateScope": {
    ...
    "sourcePattern": "RPP-0860-no-tunnel-policy-pattern",
    "supportOnly": true,
    "productionBacked": false,
    "releaseEligible": false,
  ...
  "scopeComparisonHash": "sha256:a31d70bb520c6084833560b892ef32790663ac311a683c84704a0aeb2f26e738",
  "proofHash": "sha256:8d83a84383f548e384e522b58547621ca267d480d5997f8e7d8b089b7e04bfdb"
}
```
...
```sh
node --check test/rpp-0880-no-tunnel-policy-proof-v4.test.js
node --test --test-name-pattern RPP-0880 test/rpp-0880-no-tunnel-policy-proof-v4.test.js
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0880-no-tunnel-policy-proof-v4.md
git diff --check
```
...
- syntax check: exit `0`
- focused RPP-0880 test: exit `0`, `5` tests passed
