# RPP-0942 release gate 2 final audit v3

Date: 2026-06-01
Audited local branch: `session/rpp-942`
Audited lane head before this evidence file: `000a1f2f5b5f65bbc65496667a0b9b163fc3090f`
Checklist item: RPP-0942 - Release gate 2 final audit, variant 3.
...
Support-only observations cannot move final release status. Missing live
topology, production auth, and production-backed durable recovery proof keep the
gate held until the checked release path reports live-boundary durable recovery
evidence.
...
```json
{
  ...
  "rppId": "RPP-0942",
  "variant": 3,
  "title": "Release gate 2 final audit v3",
  "checkedAt": "2026-06-01T02:49:00.000Z",
  "auditedBranch": "session/rpp-942",
  "auditedLaneHeadBeforeEvidence": "000a1f2f5b5f65bbc65496667a0b9b163fc3090f",
  "gate": {
    "id": "GATE-2",
  ...
  "finalReleaseEvaluator": {
    "command": "node scripts/release/check-release-gates.mjs --scope final-release --now 2026-06-01T02:49:00.000Z",
    "expectedExit": 1,
...
| --- | --- | --- |
| Audited commit | `git rev-parse HEAD` | `000a1f2f5b5f65bbc65496667a0b9b163fc3090f` before adding this evidence |
...
| Final-scope release-gate evaluator | `node scripts/release/check-release-gates.mjs --scope final-release --now 2026-06-01T02:49:00.000Z` | exit `1`, `REPRINT_PUSH_LIVE_SOURCE_REQUIRED`, `mutationAttempted: false`, final `3/20`; missing topology, auth, and recovery proof keeps release held |
| Focused syntax check | `node --check test/rpp-0942-release-gate-2-final-audit-v3.test.js` | JavaScript syntax accepted |
| Focused RPP-0942 regression | `node --test --test-name-pattern RPP-0942 test/rpp-0942-release-gate-2-final-audit-v3.test.js` | focused audit passes while preserving `support_only` and `NO-GO` |
| Evidence redaction scan | `node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0942-release-gate-2-final-audit-v3.md` | audit artifact scans cleanly |
