# RPP-0675 same-key replay after rejection, variant 4
...
- Added `test/rpp-0675-same-key-replay-after-rejection-v4.test.js`.
...
```bash
node --check test/rpp-0675-same-key-replay-after-rejection-v4.test.js
...
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0675-same-key-replay-after-rejection-v4.md
git diff --check
