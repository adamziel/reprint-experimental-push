# RPP-0860 No Tunnel Policy Proof Variant 3

Date: 2026-06-01

## Scope

RPP-0860 records deterministic local support-only evidence for the remote-tunnel
prohibition. It follows the RPP-0840 no-tunnel policy variant-2 pattern by
...
```json
{
  "schemaVersion": 1,
  "rppId": "RPP-0860",
  "proofId": "rpp-0860-no-tunnel-policy-proof-v3",
  "variant": 3,
  "title": "No tunnel policy proof candidate scope variant 3",
  ...
  "candidateScope": {
    "status": "no-tunnel-policy-candidate-v3",
    "sourcePattern": "RPP-0840-no-tunnel-policy-pattern",
    "supportOnly": true,
    "productionBacked": false,
    "releaseEligible": false,
  ...
  "scopeComparisonHash": "sha256:e1a20f15ef21265ee8ea7e4838fbe0ca7bb801fa2be15bbc9178e59cd6cc1aa0",
  "proofHash": "sha256:2d0c498c2de14b32493cca17ba6be63b06c3647313c3a895d1769ea27fba9432"
}
```
...
```sh
node --check test/rpp-0860-no-tunnel-policy-proof-v3.test.js
node --test --test-name-pattern RPP-0860 test/rpp-0860-no-tunnel-policy-proof-v3.test.js
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0860-no-tunnel-policy-proof-v3.md
git diff --check
```
...
- syntax check: exit `0`
- focused RPP-0860 test: exit `0`, `5` tests passed
