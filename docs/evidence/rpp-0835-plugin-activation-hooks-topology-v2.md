# RPP-0835 Plugin Activation Hooks Topology Variant 2

Date: 2026-06-01

## Scope

RPP-0835 records a second activation-hook topology proof using the same
candidate-scope pattern as RPP-0815. This is deterministic local support-only
...
```json
{
  ...
  "rppId": "RPP-0835",
  "variant": 2,
  "title": "Plugin activation hooks topology candidate scope variant 2",
  ...
  "candidateScope": {
    "status": "activation-hook-topology-candidate-v2",
    "sourcePattern": "rpp-0815-candidate-scope",
    "supportOnly": true,
    "productionBacked": false,
    "releaseEligible": false,
  ...
  "scopeComparisonHash": "46182445c6a47c78a4fa4e3a2b6d248fafbcec3be46e375865df1995940e200c"
}
```
...
```sh
node --check test/rpp-0835-plugin-activation-hooks-topology-v2.test.js
node --test test/rpp-0835-plugin-activation-hooks-topology-v2.test.js
node --test --test-name-pattern "activation hook" test/production-shaped-proof.test.js
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0835-plugin-activation-hooks-topology-v2.md
git diff --check
```
