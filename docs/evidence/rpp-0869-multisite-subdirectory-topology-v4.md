# RPP-0869 Multisite Subdirectory Topology Variant 4

Date: 2026-06-01

## Scope

RPP-0869 records variant 4 support evidence for multisite subdirectory
import/export survival. It carries forward the RPP-0849 variant 3 plugin and
graph survival contract and focuses the production-topology boundary on the
ordered real WordPress export, import, post-import export, plugin readback, and
graph readback sequence that must exist before release-verifier acceptance.
Production import/export, live topology readback, auth/session lifecycle,
durable journal replay, and redacted release artifacts remain required before
...
```json
{
  ...
  "rppId": "RPP-0869",
  "variant": 4,
  "title": "Multisite subdirectory import/export survival support scope v4",
  ...
  "supportReport": {
    ...
    "variantFocus": "ordered-real-wordpress-import-export-topology-survival-v4",
  ...
  "productionImportExportEvidence": {
    ...
    "observedAttempt": "not-performed-in-rpp-0869",
  ...
  "candidateScope": {
    "status": "multisite-subdirectory-import-export-survival-support-candidate-v4",
    "coverageMode": "focused-regression-support-contract-candidate-vs-release-ready",
    "supportOnly": true,
    "failClosed": true,
    "productionBacked": false,
    "releaseEligible": false,
    ...
    "countEvidence": {
      ...
      "requiredPluginSurvivalCount": 5,
      "requiredGraphTypeCount": 6,
      "requiredGraphSurvivalCount": 5,
      "focusedSupportSurfaceCount": 10,
      "unavailableCapabilityCount": 4,
      "importExportBlockerCount": 13,
      "releaseReadyGapCount": 15,
    ...
    "importExportSurvivalSurface": {
      ...
      "pluginResourceKeyHash": "97546464d39e149193a14ba20c1d0e8482463ee40278c31715f135fc92fc7b0e",
    ...
    "surfaceEvidenceHash": "4da84a3215d6c95ee09b6e72a53d72b336ac9060753e06ed3af13ca95a25c055",
    "acceptanceRules": [
    ...
    "candidateClaims": [
      "variant-4-survival-contract-carried-forward",
  ...
  "scopeComparisonHash": "50ff867cfe2f5594f6bfaddcacfa93dd7f2cc014c83e744660319f6a806ab0ae"
}
```
...
ordered import/export sequence required for topology survival; and the plugin
and graph survival surfaces that must survive a real WordPress import/export
run.
...
evidence survived the ordered export, import, and post-import export cycle.

Until production-backed proof and accepted production-topology release-verifier
evidence exist, RPP-0869 remains NO-GO for final release integration.
...
```sh
node --check test/rpp-0869-multisite-subdirectory-topology-v4.test.js
node --test --test-name-pattern RPP-0869 test/rpp-0869-multisite-subdirectory-topology-v4.test.js
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0869-multisite-subdirectory-topology-v4.md
git diff --check
```
