...
| Final-scope release-gate evaluator | `node scripts/release/check-release-gates.mjs --scope final-release --now 2026-06-01T02:45:00.000Z` | exit `1`, final release `NO-GO`, 18 blocking risks, no mutation |
