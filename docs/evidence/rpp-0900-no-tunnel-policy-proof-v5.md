# RPP-0900 No Tunnel Policy Proof Variant 5

Date: 2026-06-01

## Scope

RPP-0900 records deterministic local support-only evidence for the remote-tunnel
prohibition. It follows the RPP-0880 no-tunnel policy variant-4 pattern by
validating only in-memory Docker topology plans and storing hash, count, and
surface summaries.
...
```json
{
  "schemaVersion": 1,
  "rppId": "RPP-0900",
  "proofId": "rpp-0900-no-tunnel-policy-proof-v5",
  "variant": 5,
  "title": "No tunnel policy proof candidate scope variant 5",
  ...
  "candidateScope": {
    "status": "no-tunnel-policy-candidate-v5",
    "sourcePattern": "RPP-0880-no-tunnel-policy-pattern",
    "supportOnly": true,
    "productionBacked": false,
    "releaseEligible": false,
  ...
  "scopeComparisonHash": "sha256:0975189b21012ad3c6d513678b299f21222baa978a54aa6cb78d7244453b6dcb",
  "proofHash": "sha256:aa3dc0c6b36464000e6ca1726068ddcb2cdf7b4958fb6a1fb78559c5745f8397"
}
```
...
```sh
node --check test/rpp-0900-no-tunnel-policy-proof-v5.test.js
node --test --test-name-pattern RPP-0900 test/rpp-0900-no-tunnel-policy-proof-v5.test.js
node scripts/release/artifact-redaction-scan.mjs docs/evidence/rpp-0900-no-tunnel-policy-proof-v5.md
git diff --check
```
...
- syntax check: exit `0`
- focused RPP-0900 test: exit `0`, `5` tests passed
