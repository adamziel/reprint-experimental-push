# RPP-0889 Multisite Subdirectory Topology Variant 5

Date: 2026-06-01

## Scope

RPP-0889 records variant 5 support evidence for multisite subdirectory
import/export survival. It carries forward the RPP-0869 and RPP-0849 support
contracts and tightens the release-verifier boundary around same-artifact
plugin and graph survival. The success contract requires plugin-driver
evidence and every required graph surface to survive the same production-backed
real WordPress export, import, and post-import export artifact for a multisite
subdirectory topology.

This is support-only evidence. It does not call WordPress routes, does not run
import/export, does not start servers, does not use live topology, does not
...
```json
{
  ...
  "rppId": "RPP-0889",
  "variant": 5,
  "title": "Multisite subdirectory same-artifact import/export survival support scope v5",
  ...
  "successContract": "same-artifact-plugin-and-graph-evidence-survive-real-wordpress-import-export-for-multisite-subdirectory",
  ...
  "builtOn": {
    "previousSupportScope": {
      ...
      "productionTopologyBoundary": true,
  ...
  "supportReport": {
    ...
    "variantFocus": "same-artifact-real-wordpress-import-export-survival-v5",
    ...
    "exactUnavailableCapabilities": [
      {
        ...
        "requiredFor": [
          ...
          "same-artifact-plugin-and-graph-survival-readback"
        ]
      },
      {
      ...
      },
      {
        ...
        "requiredFor": [
          "same-artifact-plugin-evidence-survives-import-export",
          "same-artifact-graph-evidence-survives-import-export",
  ...
  "candidateScope": {
    "status": "multisite-subdirectory-import-export-survival-support-candidate-v5",
    "coverageMode": "release-verifier-regression-support-contract-candidate-vs-release-ready",
    "supportOnly": true,
    "failClosed": true,
    "productionBacked": false,
    "releaseEligible": false,
    ...
    "countEvidence": {
      ...
      "requiredPluginSurvivalCount": 6,
      "requiredGraphTypeCount": 6,
      "requiredGraphSurvivalCount": 6,
      "focusedSupportSurfaceCount": 11,
      "unavailableCapabilityCount": 4,
      "importExportBlockerCount": 17,
      "releaseReadyGapCount": 17,
      "runtimeGapCategoryCount": 6,
      "importExportTopologySequenceStepCount": 6,
      "releaseVerifierCarryThroughSurfaceCount": 1,
      "explicitRejectionRuleCount": 5,
    ...
    "importExportSurvivalSurface": {
      ...
      "sameArtifactEvidenceRequired": true,
      "sameArtifactBindingHash": "7128b28830fa4b09b2c1e09b298dd9d3bdaba1efd16c86eb4efe3edb54542506",
      ...
      "pluginResourceKeyHash": "af270b907316ad7e9a4b93e5ffef685b2d7f6e062cd1808eb4eaa8cb69c8e6f1",
      "requiredPluginSurvival": [
        "same-artifact-id-hash",
        "survived-import",
        "survived-export",
    ...
    "surfaceEvidence": [
      ...
      },
      {
        ...
        "hash": "81937a3371fa797d32088f4e1479ce742b0c0012ebc56a49815bf1537a70be2d"
      },
      {
      ...
      },
      {
        ...
        "countKeys": [
          "importExportTopologySequenceStepCount",
          "productionTopologyEvidenceCount"
        ],
        "hash": "2fed6b6fdaa7a4d42d3a4eb9b0b3709f55372c0a205867dfeb656e51094da03a"
      },
      {
        ...
        "hash": "45dc65258e75048ea509661dd37a6bf312b19e90eb1f8077a7de70fd1f2e371b"
      },
      {
    ...
    "importExportBlockers": [
      ...
      "no-ordered-import-export-topology-survival-sequence",
      ...
      "no-release-verifier-accepted-same-artifact-readback",
    ...
    "releaseReadyGaps": [
      ...
      "ordered-import-export-topology-survival-sequence",
    ...
    "excludedFromCandidate": [
      ...
      "packaged-fallback-release-claim",
      "playground-or-subdomain-substitute-release-claim",
      "partial-survival-release-claim",
      "sequence-incomplete-release-claim",
  ...
  "releaseReadyScope": {
    ...
    "requiredEvidence": [
      ...
      "ordered-export-import-export-sequence-with-plugin-and-graph-survival-hashes",
    ...
    "blockers": [
      ...
      "candidate-does-not-reject-packaged-fallback-playground-subdomain-partial-or-sequence-incomplete-release-claims",
      "release-artifact-bundle-not-present",
      "candidate-does-not-support-final-release-go"
    ],
    "readyWhen": "all-required-evidence-passes-with-productionBacked-true-releaseEligible-true-same-artifact-survival-and-release-verifier-acceptance"
  },
  "redaction": {
  ...
  "scopeComparisonHash": "19d13128c2b11c00078b0038dbfe64b8979f7feb06c275659e19d86c20bb5163"
}
```
...
network and site-scoped table surfaces; subdirectory network constants; the
ordered import/export sequence required for topology survival; the same-artifact
binding required for plugin and graph evidence; and the release-verifier
boundary that remains unmet.
...
The candidate explicitly rejects packaged fallback artifacts, local Playground
substitutes, multisite subdomain substitutes, partial plugin or graph survival,
and sequence-incomplete import/export evidence as release proof.
...
evidence survived the same ordered export, import, and post-import export
artifact.

Until production-backed proof and accepted production-topology release-verifier
evidence exist, RPP-0889 remains NO-GO for final release integration.
...
```sh
node --check test/rpp-0889-multisite-subdirectory-topology-v5.test.js
...
- `node --check test/rpp-0889-multisite-subdirectory-topology-v5.test.js`: exit 0
- `node --test --test-name-pattern RPP-0889 test/rpp-0889-multisite-subdirectory-topology-v5.test.js`: exit 0
