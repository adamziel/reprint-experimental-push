...
maybeTest('production-shaped live protocol proof runs the real preflight plus snapshot, dry-run, and apply boundary', () => {
  ...
  assert.match(proof.stdout, /"recoveryInspect": \{[\s\S]*"writerLease": \{\s*"strategy": "claim-fenced-single-writer",\s*"claimKeyUnique": true,\s*"fsyncEvidence": true,\s*"storageGuard": "wpdb-single-statement-cas",\s*"monotonicSequence": true,\s*"restartReadable": true,\s*"staleClaimRejected": false\s*\}/);
  ...
  assert.match(proof.stdout, /"recoveryInspect": \{[\s\S]*"leaseFence": \{[\s\S]*"writerLease": \{\s*"strategy": "claim-fenced-single-writer",\s*"claimKeyUnique": true,\s*"fsyncEvidence": true,\s*"storageGuard": "wpdb-single-statement-cas",\s*"monotonicSequence": true,\s*"restartReadable": true,\s*"staleClaimRejected": false\s*\}/);
  ...
  assert.match(proof.stdout, /"dbJournal": \{[\s\S]*"writerLease": \{\s*"strategy": "claim-fenced-single-writer",\s*"claimKeyUnique": true,\s*"fsyncEvidence": true,\s*"storageGuard": "wpdb-single-statement-cas",\s*"monotonicSequence": true,\s*"restartReadable": true,\s*"staleClaimRejected": false\s*\}/);
  ...
  assert.match(proof.stdout, /"dbJournal": \{[\s\S]*"leaseFence": \{[\s\S]*"writerLease": \{\s*"strategy": "claim-fenced-single-writer",\s*"claimKeyUnique": true,\s*"fsyncEvidence": true,\s*"storageGuard": "wpdb-single-statement-cas",\s*"monotonicSequence": true,\s*"restartReadable": true,\s*"staleClaimRejected": false\s*\}/);
});
