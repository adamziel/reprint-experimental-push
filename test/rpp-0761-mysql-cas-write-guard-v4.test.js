...
test('RPP-0761 variant 4 benchmark command reports runtime, resources, and pass gates', () => {
  ...
  assert.equal(proof.rppId, 'RPP-0761');
...
test('RPP-0761 variant 4 benchmark command exposes fail gates with runtime and resources', () => {
  const result = runBenchmarkCommand([
    '--iterations',
