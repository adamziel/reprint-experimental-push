...
const REQUIRED_CHECK_DATA = [
  ...
  {
    id: 'artifact-redaction-provenance-proof',
    title: 'Artifact redaction and immutable provenance proof',
    area: 'artifact-redaction-provenance',
    ownerScope: 'artifact-integrity',
    severity: 'blocking',
    productionRequired: true,
    command: 'node --test test/push-planner.test.js',
    artifacts: [
      'src/planner.js',
