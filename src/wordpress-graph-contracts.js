...
export const WORDPRESS_GRAPH_RELATIONSHIP_CONTRACTS = Object.freeze([
  ...
  graphRelationshipContract({
    ...
    sourceSuffix: 'options',
    sourceField: 'option_value',
    sourceCondition: 'option_name:page_on_front',
    targetSuffix: 'posts',
    targetValidation: 'post-type:page',
  }),
  graphRelationshipContract({
    relationshipType: 'option-page-for-posts-post',
    sourceSuffix: 'options',
    sourceField: 'option_value',
    sourceCondition: 'option_name:page_for_posts',
    targetSuffix: 'posts',
    targetValidation: 'post-type:page',
  }),
  graphRelationshipContract({
